...
flags.DEFINE_integer('image_width', 224, 'the width of the input image')
flags.DEFINE_integer('image_height', 224, 'the height of the input image')
...
flags.DEFINE_integer('batch_size', 32, 'batch size when running network')
flags.DEFINE_integer('epoch', 20, 'epoch of training the all data')
flags.DEFINE_integer('test_iter', 10, 'iteration when training')
flags.DEFINE_integer('save_iter', 100, 'iteration when training')
flags.DEFINE_float('init_learning_rate', 0.01, 'the initial value of learning rate')
flags.DEFINE_string('network', 'repo_network', 'network arch')
